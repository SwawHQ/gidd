---
name: gidd
description: Diagnose a project's local prerequisites when the user asks to initialize GIDD or troubleshoot its environment. Currently supports Windows setup diagnosis; automated installation and Issue/PR workflows are not yet implemented.
license: MIT
---
...
Installation, TOML configuration, authentication, and GitHub development automation remain unimplemented. Do not claim they ran or infer authorization to install from a diagnostic failure. Future JavaScript logic must use standard APIs supported by both Node.js and Bun.
