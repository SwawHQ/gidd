---
description: "An Issue and a PR workflow are required. Ask before merging or handling related failures; the Agent continues other stages automatically."
...
## commit
Current policy: autonomous handling (commit includes push by default).
...
Current policy: once acceptance criteria and repository merge requirements are satisfied, you must not continue automatically with merging.
