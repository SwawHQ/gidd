...
## Merge
Current policy: if using a separate branch or PR workflow, you may merge autonomously once acceptance criteria and repository merge requirements are satisfied.
