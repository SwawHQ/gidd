...
test('test command executes every suite and rejects failures or premature zero exits', { timeout: 120000 }, () => {
  ...
  try {
    ...
    for (const suite of ['doctor','setup','process','dev','config','github','execution','entry','repository-entry','spec']) {
    ...
    assert.match(result.stdout,/Suite summary: 8 passed, 2 failed/);
