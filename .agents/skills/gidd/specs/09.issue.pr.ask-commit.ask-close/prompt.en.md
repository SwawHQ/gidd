---
description: "An Issue and a PR workflow are required. Ask before commit/push and whether to close the Issue; the Agent continues other stages automatically."
